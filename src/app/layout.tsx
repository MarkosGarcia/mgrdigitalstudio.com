...
export const metadata: Metadata = {
  ...
  title: {
    default: "MGR Digital Studio | Local SEO, AI Search & Web Design — Ottawa",
    template: "%s | MGR Digital Studio",
  },
  description:
    "Ottawa studio for local SEO, Google Business Profile optimization, AI search optimization and websites that convert. Get your business picked first on Google Maps and in AI answers. Free visibility audit.",
  keywords: [
    "local SEO Ottawa",
    ...
    "Ottawa web design",
    "review generation",
    "small business marketing Ottawa",
  ],
  openGraph: {
    type: "website",
    url: siteUrl,
    siteName: "MGR Digital Studio",
    title: "MGR Digital Studio | Local SEO, AI Search & Web Design — Ottawa",
    description:
      "Local SEO, AI search optimization and websites that get Ottawa businesses picked first on Google and in AI answers.",
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "MGR Digital Studio" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "MGR Digital Studio",
    description: "Get picked first on Google and in AI search.",
    images: ["/og-image.jpg"],
  },
  alternates: {
    canonical: siteUrl,
  ...
  "@graph": [
    {
      ...
      name: BRAND_NAME,
      description:
        "An Ottawa digital studio offering local SEO and Google Maps optimization, AI search optimization, conversion-focused websites and review growth for local businesses, in English and Spanish.",
      url: siteUrl,
